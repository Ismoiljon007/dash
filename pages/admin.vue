                    ...
                    <div class="relative mt-2">
                        ...
                        <Transition name="fade">
                            <ul class="drop-list hidden absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                ...
                                <li @click="itemChange(), filterParams.age = item.name" class="drop-item cursor-pointer text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9 hover:bg-[#f1f5f9]"
                                    id="listbox-option-0" role="option" v-for="item in students" :key="item"
                                    :class="checkedStudent === item.name ? 'bg-[#f1f5f9]' : ''">
                                    <div class="flex items-center">
                                        <span class="font-normal ml-3 block truncate">{{ item.name }}</span>
                    ...
                    <div class="relative mt-2">
                        ...
                        <Transition name="fade">
                            <ul class="drop-list hidden absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                ...
                                <li @click="itemChange(), filterParams.class = item.name" class="drop-item cursor-pointer text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9 hover:bg-[#f1f5f9]"
                                    id="listbox-option-0" role="option" v-for="item in students" :key="item"
                                    :class="checkedStudent === item.name ? 'bg-[#f1f5f9]' : ''">
                                    <div class="flex items-center">
                                        <span class="font-normal ml-3 block truncate">{{ item.name }}</span>
                    ...
                    <div class="relative mt-2">
                        ...
                        <Transition name="fade">
                            <ul class="drop-list hidden absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                ...
                                <li @click="itemChange(), filterParams.gander = item.name" class="drop-item cursor-pointer text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9 hover:bg-[#f1f5f9]"
                                    id="listbox-option-0" role="option" v-for="item in students" :key="item"
                                    :class="checkedStudent === item.name ? 'bg-[#f1f5f9]' : ''">
                                    <div class="flex items-center">
                                        <span class="font-normal ml-3 block truncate">{{ item.name }}</span>
                    ...
                    <div class="relative mt-2">
                        ...
                        <Transition name="fade">
                            <ul class="drop-list hidden absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                ...
                                <li @click="itemChange(), filterParams.emotion = item.name" class="drop-item cursor-pointer text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9 hover:bg-[#f1f5f9]"
                                    id="listbox-option-0" role="option" v-for="item in students" :key="item"
                                    :class="checkedStudent === item.name ? 'bg-[#f1f5f9]' : ''">
                                    <div class="flex items-center">
                                        <span class="font-normal ml-3 block truncate">{{ item.name }}</span>
